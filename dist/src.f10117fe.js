...
exports.View = void 0; // interface HasId {
//   id?: number;
// }
// @ts-ignore
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), // @ts-ignore
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"C:/Users/alamg/AppData/Roaming/nvm/v16.13.2/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
